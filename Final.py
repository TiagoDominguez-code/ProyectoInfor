...
def mostrar_estadisticas(ventana, estadisticas):
    ...
    # Actualiza el área al cambiar tamaño
    ...
    encabezado = tk.Frame(scrollable_frame, bg="#e0e0e0")
...
def abrir_feedback(ventana_principal):
    ...
    ventana.geometry('500x580') # Reducido
...
class QuizApp:
    ...
    def load_category(self, category_name):
        ...
        self.questions = QUIZ_DATA[category_name][:]
